...
int main(int argc, char *argv[]) {
    ...
    if (argc != 4) {
        std::cout << "Usage: ./u250_rx <xclbin_file> <our fpga_id> <their fpga_id>" << std::endl;
        return EXIT_FAILURE;
    }
    else {
    ...
    auto l1 = NetDataTransfer(u250, 1); // 1 for interface 1.
    ...
    l1.setNetAddress(our_ip, our_mac, stoi(our_port));
